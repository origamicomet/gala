...
typedef enum gala_command_type {
  ...
  // Shaders
  GALA_COMMAND_TYPE_CREATE_SHADER,
  GALA_COMMAND_TYPE_DESTROY_SHADER,

  // Input Layouts
  GALA_COMMAND_TYPE_CREATE_INPUT_LAYOUT,
  GALA_COMMAND_TYPE_DESTROY_INPUT_LAYOUT,
  ...
  GALA_COMMAND_TYPE_SET_SHADERS,
  GALA_COMMAND_TYPE_SET_INPUT_LAYOUT,
